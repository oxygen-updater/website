...
<subtitle>OS Updater is an open-source app for OPPO/OnePlus/realme devices that allows you to install official OTA (over-the-air) updates ASAP. Ensure your device is up-to-date — it's quick, easy, and free! We regularly publish news articles informing our users about OPPO/OnePlus/realme-related things, including helpful guides and project updates.</subtitle>
...
<category term="OPPO" label="OPPO"/>
<category term="realme" label="realme"/>
<rights>${copyright}</rights>
</entry>
`;
	}, '') + '</feed>';
